...
def main():
    ...
    briefing_filepath = os.path.join(os.path.dirname(__file__), 'client_briefing.json')
    ...
    try:
        ...
        prompt_used = generated_data["prompt_used"]
        tokens_consumed = generated_content.get("tokens_consumed", 0) # Assumindo que o custo e tokens estão no generated_content
        api_cost_usd = generated_content.get("api_cost_usd", 0.0)
